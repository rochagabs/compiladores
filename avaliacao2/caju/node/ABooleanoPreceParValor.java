...
public final class ABooleanoPreceParValor extends PPreceParValor
{
    private TBooleano _booleano_;

    public ABooleanoPreceParValor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABooleanoPreceParValor(
    ...
    {
        ((Analysis) sw).caseABooleanoPreceParValor(this);
    }
