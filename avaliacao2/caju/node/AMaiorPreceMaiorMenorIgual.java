...
public final class AMaiorPreceMaiorMenorIgual extends PPreceMaiorMenorIgual
{
    private TMaior _maior_;

    public AMaiorPreceMaiorMenorIgual()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorPreceMaiorMenorIgual(
    ...
    {
        ((Analysis) sw).caseAMaiorPreceMaiorMenorIgual(this);
    }
