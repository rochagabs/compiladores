...
public final class ACaracterePreceParValor extends PPreceParValor
{
    private TCaractere _caractere_;

    public ACaracterePreceParValor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACaracterePreceParValor(
    ...
    {
        ((Analysis) sw).caseACaracterePreceParValor(this);
    }
