...
public final class AMaiorIgualPreceMaiorMenorIgual extends PPreceMaiorMenorIgual
{
    private TMaiorIgual _maiorIgual_;

    public AMaiorIgualPreceMaiorMenorIgual()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorIgualPreceMaiorMenorIgual(
    ...
    {
        ((Analysis) sw).caseAMaiorIgualPreceMaiorMenorIgual(this);
    }
