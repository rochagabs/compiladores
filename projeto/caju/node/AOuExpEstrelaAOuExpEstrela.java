...
public final class AOuExpEstrelaAOuExpEstrela extends PAOuExpEstrela
{
    private PAExp _aExp_;

    public AOuExpEstrelaAOuExpEstrela()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AOuExpEstrelaAOuExpEstrela(
    ...
    {
        ((Analysis) sw).caseAOuExpEstrelaAOuExpEstrela(this);
    }
