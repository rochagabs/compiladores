...
public final class AVazioATipoRetorno extends PATipoRetorno
{
    private TPalavraVazio _palavraVazio_;

    public AVazioATipoRetorno()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAVazioATipoRetorno(this);
    }
