...
public final class ANumeroPalavraATipoBase extends PATipoBase
{
    private TNumeroPalavra _numeroPalavra_;

    public ANumeroPalavraATipoBase()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANumeroPalavraATipoBase(
    ...
    {
        ((Analysis) sw).caseANumeroPalavraATipoBase(this);
    }
